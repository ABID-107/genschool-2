...
export default function Home() {
  ...
  return (
    <>
      ...
      >
        <a href="#" className="flex items-center gap-2.5 text-[1.5rem] font-bold text-[#0f172a] no-underline font-bricolage">
          <div className="w-9 h-9 rounded-[10px] bg-linear-to-br from-[#1a56e8] to-[#4f46e5] flex items-center justify-center text-white font-extrabold">
            G
          </div>
          <span>GenSchool</span>
        </a>
        <div className="flex items-center gap-2">
          ...
          <button
            onClick={toggleLang}
            className="px-4 py-1.75 rounded-lg border border-[#e2e8f0] bg-transparent cursor-pointer text-[.85rem] font-medium text-[#475569] transition-all hover:border-[#1a56e8] hover:text-[#1a56e8] hover:bg-[#e8f0ff]"
          >
            {lang === "en" ? "বাং" : "EN"}
          </button>
          <button

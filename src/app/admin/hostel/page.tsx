  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-slate-500 mt-1">Manage rooms, student allocation, and warden tracking.</p>
      </div>
      ...
      <div className="bg-white rounded-2xl border border-slate-200 shadow-sm p-12 flex flex-col items-center justify-center text-center">
        ...
        <h3 className="text-lg font-semibold text-slate-700 mb-2">Hostel Configuration</h3>
        <p className="text-slate-500 max-w-md mx-auto text-sm">Hostel fees are automatically synchronized with the Finance module for invoicing.</p>

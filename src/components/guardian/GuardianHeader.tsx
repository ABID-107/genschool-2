      ...
      <div className="flex-1 max-w-xl">
        <div className="relative group">
          ...
          <input
            ...
            placeholder="Search children, teachers, or notices..."
          />
        </div>
      </div>
      ...
      <div className="flex items-center gap-4 pl-4">
        ...
        <button className="btn-ghost flex items-center gap-3 p-1.5 pr-3 rounded-full">
          ...
          <div className="flex flex-col items-start hidden sm:flex">
            <span className="text-sm font-semibold text-[var(--text-primary)] leading-tight">Alex Johnson</span>
            <span className="text-xs text-[var(--text-muted)]">Guardian</span>
          </div>
        </button>
      </div>
    </header>

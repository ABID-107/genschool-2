  ...
  return (
    <section id="overview" className="animate-in fade-in duration-500">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-4 mb-6 md:mb-8">
        <div>
          <h1 className="text-2xl md:text-3xl font-bold text-slate-900 mb-1 md:mb-2 font-bricolage tracking-tight">Welcome back, {teacherName}</h1>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
        <div className="glass-card p-6 flex items-center gap-4 group">
          ...
          <div>
            ...
            <h3 className="text-2xl font-bold text-slate-900 font-bricolage">1,284</h3>
          </div>
        </div>
        <div className="glass-card p-6 flex items-center gap-4 group">
          ...
          <div>
            ...
            <h3 className="text-2xl font-bold text-slate-900 font-bricolage">12</h3>
          </div>
        </div>
        <div className="glass-card p-6 flex items-center gap-4 group">
          ...
          <div>
            ...
            <h3 className="text-2xl font-bold text-slate-900 font-bricolage">{assignments.length}</h3>
          </div>
        </div>
      </div>
    </section>
